    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg bg-slate-50 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 shadow-md">
        <h1 className="text-3xl font-semibold text-center text-gray-50">
          Sign up for <span className="text-gray-50">Falaê</span>
        </h1>
...
// 						</label>
// 						<input type='text' placeholder='johndoe' className='w-full input h-10 bg-black/15 text-white bg-clip-padding border-white/15 placeholder:text-white/55 bg-opacity-20 focus:bg-opacity-30 focus:outline-none focus:border-gray-300' />
// 					</div>
